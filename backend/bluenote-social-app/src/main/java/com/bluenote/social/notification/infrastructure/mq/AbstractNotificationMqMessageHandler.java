...
abstract class AbstractNotificationMqMessageHandler implements RocketMqMessageHandler {

    private static final Logger log = LoggerFactory.getLogger(AbstractNotificationMqMessageHandler.class);
    ...
    AbstractNotificationMqMessageHandler(
    ...
    public void handle(MqInboundMessage message) {
        NotificationConsumeEventRequest request = toRequest(message);
        ...
        try {
            notificationApplicationService.consumeEvent(request);
            log.info("Notification MQ event consumed, group={}, topic={}, eventId={}, eventType={}",
    ...
    private NotificationConsumeEventRequest toRequest(MqInboundMessage message) {
