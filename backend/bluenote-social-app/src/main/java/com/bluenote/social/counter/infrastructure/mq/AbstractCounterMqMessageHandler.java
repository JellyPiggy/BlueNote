...
abstract class AbstractCounterMqMessageHandler implements RocketMqMessageHandler {

    private static final Logger log = LoggerFactory.getLogger(AbstractCounterMqMessageHandler.class);
    ...
    AbstractCounterMqMessageHandler(
    ...
    public void handle(MqInboundMessage message) {
        CounterConsumeEventRequest request = toRequest(message);
        ...
        try {
            counterApplicationService.consumeEvent(request);
            log.info("Counter MQ event consumed, group={}, topic={}, eventId={}, eventType={}",
    ...
    private CounterConsumeEventRequest toRequest(MqInboundMessage message) {
        ...
        return new CounterConsumeEventRequest(
                message.topic(),
                consumerGroup,
